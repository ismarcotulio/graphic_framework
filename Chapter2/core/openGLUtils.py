...
class OpenGLUtils(object):
    ...
    def initializeShader(shaderCode, shaderType):
        ...
        # compiles source code previously store in the shader object
        glCompileShader(shaderRef)
        #queries wether shader compile was successful
    ...
    def initializeProgram(vertexShaderCode, fragmentShaderCode):
        ...
        # queries wheter program link was successful
        ...
        if not linkSuccess:
            ...
            # convert byte string to character string
            errorMessage = '\n' + errorMessage.decode('utf-8')
            # raise exception: halt applicationand print error message.
            raise Exception(errorMessage)
    ...
    def printSystemInfo():
        ...
        print("GLSL version supported: " + glGetString(GL_SHADIN_LANGUAGE_VERSION).decode('utf-8'))
